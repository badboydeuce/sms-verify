...
def paystack_callback():
    ...
    if result['success']:
        ...
        if user_id:
            ...
            return "<h2>✅ Payment Verified (User not mapped)</h2>", 200
    else:
...
def credit_wallet(user_id, amount, reference):
    """Top up user wallet - connect your DB here later"""
    logger.info(f"💰 Wallet Top-up: User {user_id} + ₦{amount} | Ref: {reference}")
    ...
    try:
        ...
        bot.send_message(
            ...
            text=f"✅ **Payment Confirmed!**\n\n"
                 ...
                 f"You can now buy virtual numbers.",
            parse_mode='Markdown'
        )
    except Exception as e:
